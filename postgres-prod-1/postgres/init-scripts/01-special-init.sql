...
CREATE USER linkwarden  WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 20;
CREATE USER dockhand    WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 10;
CREATE USER n8n         WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 20;
CREATE USER scanopy     WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 10;
CREATE USER immich      WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 30;
CREATE USER paperless   WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 10;
CREATE USER semaphore   WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 10;
CREATE USER authentik   WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 10;
CREATE USER infisical   WITH PASSWORD 'XXXXXXX!' CONNECTION LIMIT 10;
